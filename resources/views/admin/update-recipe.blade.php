            ...
            <div class="mt-5 isi mx-auto border border-dark rounded">
                <form action="{{url('/updateRecipe/'.$recipe->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="price" name="price" value="{{$recipe->price}}">
                        <div id="emailHelp" class="form-text">{{$errors->first('price')}}</div>
                    </div>
                    <div class="mb-3">
                        <label for="stock" class="form-label">Author</label>
                        <input type="text" class="form-control" id="stock" name="author" value="{{$recipe->author}}">
